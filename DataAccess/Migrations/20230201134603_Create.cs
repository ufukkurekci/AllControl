        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoalCount = table.Column<short>(type: "smallint", nullable: false),
                    ...
                    RecordStatus = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: false, defaultValue: "A"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DailyToDos_ToDos_ToDoId",
                        column: x => x.ToDoId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "bdf859ff-e8be-4bf9-8ac3-5f91b4b71765", "Admin", "ADMIN" },
                    { 2L, "2052cdf0-b494-4932-bbb7-079fc5aa6fb9", "User", "USER" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_DailyToDos_ToDoId",
                table: "DailyToDos",
                column: "ToDoId");
